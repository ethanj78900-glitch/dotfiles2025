...
export LD_LIBRARY_PATH="/home/gagbo/soft/openmpi-3.0.0/lib:${LD_LIBRARY_PATH}";
# Use OpenMPI 3.0.0 by default
export PATH="/home/gagbo/soft/openmpi-3.0.0/bin:${PATH}"

# SML for OSSU course
export PATH="/home/gagbo/soft/smlnj/bin:${PATH}"
# Rust env
